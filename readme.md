# Sheep dataset (1500 images) in YOLO format electronic document.

# Body

Sheep Dataset (1500 images) in YOLO format, electronic data, suitable for target detection training.
The dataset images are clear and labeled comprehensively, supporting the training of YOLO models.
send to the cloud drive link, if there is any problem, please chat anytime
